 ...
 */
final class Version20240603090503 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE product_variant (id INT AUTO_INCREMENT NOT NULL, taxe_id INT NOT NULL, product_id INT NOT NULL, price DOUBLE PRECISION NOT NULL, size DOUBLE PRECISION NOT NULL, INDEX IDX_209AA41D1AB947A4 (taxe_id), INDEX IDX_209AA41D4584665A (product_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
